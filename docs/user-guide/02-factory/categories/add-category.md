...
| ---- | ----------- | ------------------------ | ------------------------------------- |
| 1    | Name        | Enter category name      | Defines how products will be grouped  |
...
| Created At | Date the category was created |
...
- The category will be available when creating or editing products
